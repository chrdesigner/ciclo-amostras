...
if(function_exists("register_field_group"))
{
	...
	register_field_group(array (
		'id' => 'acf_ciclo-de-visita',
		'title' => 'Ciclo de Visita',
		'fields' => array (
			array (
				'key' => 'field_6699834a62b92',
				'label' => 'Ciclo de Visita Acabou?',
				'name' => 'ciclo_visite_acabou',
				'type' => 'true_false',
				'instructions' => 'Selecione o campo abaixo, se o ciclo de visita acabou',
				'required' => 0,
				'message' => 'O ciclo de visita já finalizou?',
				'default_value' => 0,
			),
		),
		'location' => array (
